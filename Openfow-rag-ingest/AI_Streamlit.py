...
CORTEX_SEARCH_SERVICES = "OPENFLOW_LLM_DEMO.LLM_DATA.DEMO_SEARCH_AI"
                ...
                with st.chat_message("assistant"):
                    ...
                    if citations:
                        ...
                        for citation in citations:
                            ...
                            if doc_id:
                                query = f"SELECT CHUNK FROM OPENFLOW_LLM_DEMO.LLM_DATA.DOCS_CHUNKS WHERE DOC_ID = '{doc_id}'"
